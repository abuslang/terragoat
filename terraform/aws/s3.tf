resource "aws_s3_bucket" "data" {
  ...
  tags = merge({
    ...
    git_modifiers        = "asquadri1/jonjozwiak/nimrodkor/schosterbarak"
    git_org              = "abuslang"
    git_repo             = "terragoat"
...
resource "aws_s3_bucket" "data_science" {
  ...
  force_destroy = false
  tags = {
    git_commit           = "e42a417a04d5cd0a2dc8b68b6809157b67d6f6d9"
    git_file             = "terraform/aws/s3.tf"
    git_last_modified_at = "2023-06-05 19:22:51"
    git_last_modified_by = "asquadri1@gmail.com"
    git_modifiers        = "asquadri1/nimrodkor/schosterbarak"
    git_org              = "abuslang"
    git_repo             = "terragoat"
